...
import { getLastNDays, formatDateDisplay, formatDate, isToday, getCompletionStatus } from '../utils/streaks';
import { Check, X, MoreVertical, Edit2, Trash2, ChevronLeft, ChevronRight } from 'lucide-react';
...
const HabitGrid = () => {
  const { habits, completions, toggleCompletion, deleteHabit, loadCompletions } = useHabitStore();
  ...
  const handleDelete = async (habitId) => {
    if (window.confirm('Are you sure you want to delete this habit? This will also delete all its history.')) {
        ...
        <div className="flex items-center px-4 py-3">
          ...
          >
            <div className="flex gap-1 min-w-max px-2">
              <div className="w-32 flex-shrink-0" /> {/* Spacer for habit names */}
        ...
        {habits.map((habit, habitIndex) => (
          ...
          >
            ...
            <div className="w-32 flex-shrink-0 flex items-center gap-2">
              <div className={`w-3 h-3 rounded-full ${HABIT_COLORS[habit.color] || HABIT_COLORS.blue} flex-shrink-0`} />
